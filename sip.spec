...
Source0  : https://files.pythonhosted.org/packages/3e/f5/85bfb3c716b8eda9e2b0c0c5f36acb701746045c828a4497a44e581db3a6/sip-6.8.5.tar.gz
...
%prep
%setup -q -n sip-6.8.5
cd %{_builddir}/sip-6.8.5
%patch -P 1 -p1
pushd ..
cp -a sip-6.8.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719260198
