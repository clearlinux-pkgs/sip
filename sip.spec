...
Source0  : https://files.pythonhosted.org/packages/a6/4e/c34eee70109e9a8110672f074fc18b5022bf4b9b4c92641245c73ae0b21a/sip-6.7.12.tar.gz
...
%prep
%setup -q -n sip-6.7.12
cd %{_builddir}/sip-6.7.12
%patch -P 1 -p1
pushd ..
cp -a sip-6.7.12 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698428095
